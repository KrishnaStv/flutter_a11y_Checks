...
class AltTextDecorativeImages extends StatelessWidget {
  ...
  final String geRuleDescription = 'Not decided.';
  ...
  Widget build(BuildContext context) {
    ...
    var beassertImagePAth =
        new AssetImage('assets/images/decorativeimagesquares.png');
    ...
    return Scaffold(
      appBar: new AppBarExtension(
          navdata: TopBarData(
              title: SCs.AltTextDecorativeImages.pageTitle, enableBack: true)),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: HeaderSemanticWithText(
                            'Good Example: ImageView without accessibility description'),
                      ),
                      Text(ruleDescription),
                    ],
                  )),
                  ...
                  child: Column(
                    children: [
                      Container(
                        alignment: Alignment.topLeft,
                        child: HeaderSemanticWithText(
                            'Bad Example: ImageView with accessibility description'),
                      ),
            ...
            Semantics(
              label: 'Decorative background',
              child: Container(child: beimgObject),
            ),
