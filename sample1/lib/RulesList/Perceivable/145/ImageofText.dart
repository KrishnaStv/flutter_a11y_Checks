...
class ImageofTextSample extends StatelessWidget {
  ...
  final String geDescription = 'The sample below uses a Label'
  ...
  final String beDescription = 'The use of an image with text on it induces a '
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new AppBarExtension(
          navdata:
              TopBarData(title: SCs.ImageOfText.pageTitle, enableBack: true)),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: HeaderSemanticWithText('Good Example: Text used '
              ...
              child: Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        alignment: Alignment.topLeft,
                        child: HeaderSemanticWithText('Bad Example: Image of'
