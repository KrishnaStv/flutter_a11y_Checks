...
class NameRoleValueSampleState extends State<NameRoleValueSample> {
  ...
  final Map<int, Widget> logoWidgets = const <int, Widget>{
    0: Text(
      'iOS',
      semanticsLabel: 'iOS, 1 out of 3',
    ),
    1: Text(
      'Android',
      semanticsLabel: 'Android, 2 out of 3',
    ),
    2: Text(
      'Linux',
      semanticsLabel: 'Linux, 3 out of 3',
    )
  };
  ...
  Future<void> _showDialog(
      bool enableOutSideTap, String title, String description) async {
    List<Widget> widgets = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new AppBarExtension(
          navdata:
              TopBarData(title: SCs.NameRoleValue.pageTitle, enableBack: true)),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              alignment: Alignment.topLeft,
              child: Text(
                  'By default, accessibilityTraits will be assigned for some UIElements'),
            ),
            Container(
              child: Row(
                children: [
                  Semantics(
                    button: true,
                    label: isGERadioButtonSelected
                        ? "Selected, Send Emails on exciting offer"
                        : "Send Emails on exciting offer",
                    child: Semantics(
                      excludeSemantics: true,
                      child: IconButton(
                          onPressed: () {
                            setState(() {
                              isGERadioButtonSelected =
                                  !isGERadioButtonSelected;
                            });
                          },
                          icon: isGERadioButtonSelected
                              ? Image.asset(
                                  'assets/images/radio_button_selected.png')
            ...
            Container(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                  'VoiceOver will announce as \'Send me emails on exciting offers, Button\''),
            ),
            SizedBox(
              height: 10,
            ),
            ...
            Container(
              child: Row(
                children: [
                  Semantics(
                      label: isGECheckboxButtonSelected
                          ? "I agree to the terms and conditions"
                          : "I agree to the terms and conditions",
                      child: Checkbox(
                          value: isGECheckboxButtonSelected,
            ...
            Container(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                  'VoiceOver will announce as \'I agree to the terms and conditions, Button\''),
            ),
            SizedBox(
              height: 10,
            ),
            ...
            Container(
              padding: EdgeInsets.only(left: 15, right: 15),
              child:
                  Text('VoiceOver will announce as \'Create Account, Button\''),
            ),
            SizedBox(
              height: 10,
            ),
            ...
            Container(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                  'VoiceOver will announce as \'Set Volume: $gecurrentValue,'
            ...
            Container(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                  'VoiceOver will announce as \'Set Mute,Switch button $isGESwitchSelected,'
            ...
            Container(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                  'VoiceOver will announce as \'Download Progress ${geProgresscurrentValue.toStringAsFixed(2)}, \'(Current Value)\''),
            ),
            Divider(),
            Container(
              alignment: Alignment.topLeft,
            ...
            Container(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                  'VoiceOver will announce as \'(Current Value)\',\'iOS,1 out of 3, Button,'),
            ),
            SizedBox(
              height: 20,
            ),
            ...
            Divider(),
            ElevatedButton(
              child: Text('Name Role Bad Examples'),
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) {
