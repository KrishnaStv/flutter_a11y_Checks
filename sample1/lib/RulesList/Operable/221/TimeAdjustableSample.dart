...
class TimeAdjustableSample extends StatelessWidget {
  final String ruleDescription = 'If a screen or application has a time limit,'
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new AppBarExtension(
          navdata: TopBarData(
              title: SCs.TimeAdjustable.pageTitle, enableBack: true)),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              _showDialog(
                                  false,
                                  'Time out',
                                  'Your session is closing in about 90 sec, Do you wish to extend ?',
                                  true,
                                  'No',
                                  'Yes',
                                  false);
